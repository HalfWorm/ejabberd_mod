...
clear_db(Server) ->
	...
	catch ejabberd_sql:sql_query(Server, [<<"INSERT INTO chat_status_list (user, status, showe, node, resource) VALUES \
...
on_register_connection(_SID, _JID, _Info) ->
	...
	catch ejabberd_sql:sql_query(LServer, [<<"INSERT INTO chat_status_list (user, status, showe, node, resource, ip, pid) VALUES \
